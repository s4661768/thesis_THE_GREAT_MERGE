...
#include "SparkFun_TMP117.h" //Click hc:\Users\prism\OneDrive\Documents\2024\Uni\Thesis\thesis_THE_GREAT_MERGE\SparkFun\OpenLog_Artemis\lowerPower.here to get the library: http://librarymanager/All#SparkFun_TMP117
...
void setup() {
  ...
  // productionTest(); //Check if we need to go into production test mode // Commented (Nathan)
