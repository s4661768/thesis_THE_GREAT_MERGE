...
void getData()
{
  ...
  if (settings.logSerial == true) {
    Serial1.print("hello from sensor file\r\n");
  }
  ...
  Serial1.print(myRTC.year);
  Serial1.print(" ");
  Serial1.print(myRTC.month);
  Serial1.print(" ");
  Serial1.print(myRTC.dayOfMonth);
  Serial1.print(" ");
  Serial1.print(myRTC.hour);
  Serial1.print(" ");
  Serial1.print(myRTC.minute); 
  Serial1.print(" ");           
  Serial1.print(myRTC.seconds);
  Serial1.print(" ");
  Serial1.print(myRTC.hundredths);
  Serial1.print(" ");    
  Serial1.print(" : A_X ");
  Serial1.print(myICM.agmt.acc.axes.x);
  Serial1.print(" A_Y ");
  Serial1.print(myICM.agmt.acc.axes.y);
  Serial1.print(" A_Z ");
  Serial1.print(myICM.agmt.acc.axes.z);
  Serial1.println(" ");
